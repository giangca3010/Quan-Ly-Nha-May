            ...
            <section class="panel">
                <div class="panel-body">
                    <div class="position-center">
                        <form role="form" action="{{URL::to('/saveCheTai')}}" method="post">
                            <!-- {{csrf_field()}} -->
                            @csrf
                            <div class="form-group">
                                <label for="exampleInputEmail1">TÊN CHẾ TÀI</label>
                                <input type="text" name="chetai_name" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên chế tài">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">MÔ TẢ</label>
                                <textarea style="resize: none " rows="8" class="form-control" name="chetai_mota" id="exampleInputPassword1" placeholder="Nhập hướng dẫn"></textarea>
                            </div>
                            <button type="submit" name="add_category_product" class="btn btn-info">Create</button>
                            <a href="{{URL::to('/cheTai')}}" class="btn btn-primary">Thoát</a>
