	    ...
	    <div class="modal-dialog modal-lg">
	        <div class="modal-content">
	            <div class="modal-header">
	                ...
	                <h4 class="modal-title">Dòng Tiền Nguyên Vật Liệu</h4>
	            </div>
	            <div class="modal-body addCreate">
				    ...
				    <div class="form-group col-md-6">
			            ...
			            <select id="loaichiphi">
						    ...
						    <option value="{{$item->id}}" selected="selected">{{$item->name_lcp}}</option>
						    @endforeach
						 </select>
				    </div>
				    <div class="form-group col-md-6">
	...
	<div class="modal fade" id="edit_duyet">
	    <div class="modal-dialog modal-lg">
	        <div class="modal-content">
	            ...
	            <div class="modal-footer">
	                <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
	                <a href="#" onclick="duyetchiphi()"  type="button" class="btn btn-primary">Chuyển Dòng Tiền</a>
	            </div>
	        </div>
	    </div>
	</div>
...
$('.show_duyet').click(function () {
    ...
    $.get("/showline/"+$(this).data('id'),function(data){
        $("#showncc").html(data);
    });

    $.get("/showncc/"+$(this).data('id'),function(data){
        $(".ncc").html(data);
    });
