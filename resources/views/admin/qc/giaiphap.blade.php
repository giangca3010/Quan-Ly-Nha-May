	                	...
	                	<tr role="row" class="odd">
                			...
                			<td>
	                			...
	                			<div>
	                				...
	                				<a type="button" class="delete_images" data-id="{{$value}}" data-type="2">
	                        ...
	                        <td class="sorting_1">
	                        	<a type="button" class="edit_data" data-toggle="modal" data-target="#modal-default" data-quytrinh="{{$item['quy_trinh']}}"  data-id="{{$item['id']}}"  data-huongdan="{{$item['huong_dan']}}" data-nhanvien="{{$item['nhan_vien']}}" data-code="{{$item['id_ma']}}">
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
		        	<form id="data-giaiphap" enctype="multipart/form-data">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <input class="submit_giaiphap pull-right" type="button" value="Đồng Ý">
	                    </div>
...
<script>
	$('#ma_loi').select2();
	$('.submit_giaiphap').click(function(){
        $.ajax({
            type: 'post',
            url: '{{ route("action.giaiphap") }}',
            data:  new FormData($("#data-giaiphap")[0]),
            dataType:'json', 
            async:false, 
            processData: false, 
            contentType: false, 
